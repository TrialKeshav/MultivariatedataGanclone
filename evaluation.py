...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='./pretrained_models/', help='Directory to write temporary files',required=True)
    ...
    X_train = encodedDataframe.iloc[:, :-1].values
    y_train = encodedDataframe.iloc[:, -1].values
    ...
    # Synthetic data
    args.sample_data = args.gendata_dir
    df1 = preprocessingFirstColumn(args)
